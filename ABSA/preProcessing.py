...
def createAllDependence():
    print('获取餐厅数据的句法依赖')
    createDependenceInformation('data/origin/ABSA_2014_origin/Restaurants_Train_v2.xml','dependences/re_train.dep')
    createDependenceInformation('data/origin/ABSA_2014_origin/Restaurants_Test_Data_phaseB.xml','dependences/re_test.dep')
